...
var cnItems = {
    ...
    "Album Promotion": "专辑推广",
    "effect base.": "效果基础。",
    "Fans": "粉丝",
    "Fans effect is based on the best amount, and unlock a Fans buyable.": "粉丝效果基于最佳数量，并解锁一个粉丝可购买。",
    "Fans reset nothing.": "粉丝什么都没重置。",
    "Reset Popularity for": "重置人气得到 ",
    "There is a 15-second cooldown when resetting for Fans.": "为粉丝重置时有 15 秒的冷却时间。",
    "Unlock Auto Fans Reset.": "解锁自动粉丝重置。",
    "Unlock Fans Upgrades.": "解锁粉丝升级。",
    "9,999x, +0.015 to base": "9,999x, +0.015 到基础",
    "9,999, and add 0.015 to": "9,999，并增加 0.015 到",
    "Organize Fan Club": "组织粉丝俱乐部",
    "Square Fans effect.": "平方粉丝效果。",
    "You have just attracted the group's first fan. As with the previous groups, fans will be the key to further influence growth.": "你刚刚吸引了小组的第一个粉丝。 与之前的群体一样，粉丝将是进一步影响增长的关键。",
    "Chapter 3 - Expanding the Fanbase": "第 3 章 - 扩大粉丝群",
    "Attract More Fans": "吸引更多粉丝",
    "Fan Letters": "粉丝来信",
    "Fans cooldown is halved.": "粉丝冷却时间减半。",
    "Fans effect is multiplied by the best number of Fans.": "粉丝效应乘以最佳粉丝数。",
    "Album Marketing II": "专辑营销 II",
    "Album Promotion II": "专辑宣传 II",
    "Album Sales gain is multiplied by the 4th root of the best number of Fans.": "专辑销售收益乘以最佳粉丝数的 4 次方根。",
    "Attract More Fans II": "吸粉 II",
    "Attract More Fans III": "吸引更多粉丝 III",
    "Attract More Fans IV": "吸引更多粉丝 IV",
    "Attract More Fans V": "吸引更多粉丝 V",
    "Cross Promotion": "交叉推广",
    "Cross Promotion II": "交叉推广 II",
    "Cross Promotion III": "交叉推广 III",
    "Cross Promotion IV": "交叉推广 IV",
    "Cross Promotion V": "交叉推广 V",
    "Cube": "立方体",
    "Double Album Sales.": "双专辑销售。",
    "effect base by 0.05.": "效果基数增加 0.05。",
    "effect base by 0.5.": "效果基数增加 0.5。",
    "effect.": "影响。",
    "Fan Investments": "粉丝投资",
    "Fan-Created Video Ads": "粉丝制作的视频广告",
    "Fans cooldown is reduced by 60%.": "风扇冷却时间减少 60%。",
    "Fans cooldown is reduced by a third.": "风扇冷却时间减少三分之一。",
    "Fans gain is increased based on ceil(log10(log10(best Money))).": "粉丝收益基于 ceil(log10(log10(best Money))) 增加。",
    "Fans gain is increased based on ceil(log5(log5(Popular-ity))).": "粉丝收益基于 ceil(log5(log5(Popular-ity))) 增加。",
    "Gain": "获得",
    "Increase": "增加",
    "Increase Fans gain by 1% for every Money Buyable level.": "每个 金钱可购买 等级增加 1% 的粉丝收益。",
    "is stronger based on the best number of Fans.": "基于最佳粉丝数而更强。",
    "Mass Album Purchase": "大量购买专辑",
    "Mass Streaming": "大规模流媒体",
    "Mass Streaming II": "大规模流媒体 II",
    "Official Fan Club Status": "官方粉丝俱乐部状态",
    "Planet-spanning Fanbase": "跨越星球的粉丝群",
    "Raise Fans effect ^1.5.": "提高粉丝效果 ^1.5。",
    "Ran Out of Ideas": "没有想法",
    "Reduce the both log bases in": "减少两个对数基数",
    "Reduce the outer log bases in": "减少外部对数基数",
    "Square Fans effect again.": "Square Fans 效应再次出现。",
    "There is a 0.50-second cooldown when resetting for Fans.": "为粉丝重置时有 0.50 秒的冷却时间。",
    "User-Created Banner Ad": "用户创建的横幅广告",
    "Video Views gain is multiplied by the cube root of the best number of Fans.": "视频观看次数增益乘以最佳粉丝数的立方根。",
    "Video Views gain is multiplied by the cube root of the reciprocal of Fans cooldown plus 1.": "视频观看次数增益乘以粉丝冷却时间的倒数加 1 的立方根。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPostfix = {
    ...
    " to Album Sales effect exponent": " 到专辑销售效果指数",
    ", before all other boosts.": ", 在所有其他提升之前。",
    " to GFRIEND Songs effect base": " 到 GFRIEND 歌曲效果库",
    "x Fan Gain.": "x 粉丝增益。",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^You can reset for Fans in (.+) seconds.$/, '您可以在 $1 秒内为粉丝重置。'],
    ...
    [/^Next at Infinity Popularity$/, '下一个在 无限 人气'],
    [/^National Top (.+) Fan Club$/, '全国前 $1 粉丝俱乐部'],
    [/^Next at (.+) Popularity$/, '下一个在 $1 人气'],
